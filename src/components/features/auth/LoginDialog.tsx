...
const LoginDialog = ({
  ...
  const { createData, loading: isSubmitting } = useApi<LoginFormData, LoginResponse>()
  ...
  return (
    <Dialog open={isOpen} onOpenChange={open => (open ? setOpenForm('login') : setOpenForm(null))}>
      <DialogContent>
        <DialogHeader>
        ...
        <DialogFooter className='!flex-col !items-center !justify-center'>
          <DialogDescription className='text-center'>Don&apos;t have an account?</DialogDescription>
